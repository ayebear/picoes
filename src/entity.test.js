const { testIndexers, assert } = require('./test_utils.js')
...
test(
  'entity: test if ID is read-only',
  testIndexers(world => {
    let ent = world.entity()
...
test(
  'entity: check existence of components',
  testIndexers(world => {
    world.component('position', function (x = 0, y = 0) {
      this.x = x
      this.y = y
...
test(
  'entity: remove components - onRemove',
  testIndexers(world => {
...
test(
  'entity: serialize custom components',
  testIndexers(world => {
    world.component('position', function (x = 0, y = 0) {
      this.x = x
      this.y = y
...
test(
  'entity: deserialize custom components',
  testIndexers(world => {
    world.component('position', function (x = 0, y = 0) {
      this.x = x
      this.y = y
...
test(
  'entity: check for existence of components',
  testIndexers(world => {
...
test(
  'entity: register and use prototypes',
  testIndexers(world => {
    ...
    assert(
      e.get('velocity').x === undefined && e.get('velocity').y === undefined
    )
