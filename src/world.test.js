...
const { getSize, has, testIndexers, assert } = require('./test_utils.js')
...
test(
  'component: define an object component (should be invalid)',
  testIndexers(world => {
...
test(
  'component: define an empty component',
  testIndexers(world => {
    let result = world.component('position')
    assert(result === undefined)
  })
...
test(
  'component: use an empty component',
  testIndexers(world => {
...
test(
  'component: test clearing with indexes',
  testIndexers(world => {
    world.component('position', function (x = 0, y = 0) {
      this.x = x
      this.y = y
...
test(
  'component: test entity creation with constructor parameters',
  testIndexers(world => {
    let when = 0
    world.component(
      'sprite',
...
test(
  'component: test clearing with onRemove',
  testIndexers(world => {
    let spriteCount = 0
    world.component(
      'sprite',
...
test(
  'component: test detach and attach',
  testIndexers(world => {
    let spriteCount = 0
    world.component(
      'sprite',
...
test(
  'component: test detached entities',
  testIndexers(world => {
    let ent = world
      .entity()
...
test(
  'system: define a system with arguments',
  testIndexers(world => {
...
test(
  'system: define a system with context (no key)',
  testIndexers(world => {
    const state = {
      maxVelocity: 3500,
      canvas: 'someCanvas',
...
test(
  'system: define a system with context (specific key)',
  testIndexers(world => {
    const state = {
      maxVelocity: 3500,
      canvas: 'someCanvas',
...
test(
  ...
  testIndexers(world => {
    ...
    entB
      .update('position', { x: 30, y: 40 })
      .update('velocity', { x: -1, y: 2 })
...
test(
  'system: adding entities to index',
  testIndexers(world => {
...
test(
  'system: system variadic arguments with optional components',
  testIndexers(world => {
    let created = false
    world.system(
      class {
...
test(
  'system: test indexing with each()',
  testIndexers(world => {
